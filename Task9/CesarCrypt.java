...
public class CesarCrypt {
    ...
    public static String toCodeString(ArrayList<Flower> flowers) {

        initializeASCII();
        char[] originalChars = flowers.toString().toCharArray();
    ...
    public static String toUncodeString (String cipher){

        char[] codedChars = cipher.toCharArray();
